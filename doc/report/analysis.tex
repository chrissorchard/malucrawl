...
After the first presentation an informal meeting was held to discuss progress with Chas.

\begin{enumerate}
    \item Don't need to focus on a web interface
    \item Should be able to show status of workers
    \item Should be IE in Wine
    \item ClamAV
\end{enumerate}
